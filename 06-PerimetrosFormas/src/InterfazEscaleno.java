...
public class InterfazEscaleno extends JFrame implements ActionListener {
	...
	private JLabel lbn1 = new JLabel("Ingresa el tamaño del 1er. lado");
	private JTextField txtlado1 = new JTextField();
	private JLabel lbn2 = new JLabel("Ingresa el tamaño del 2do. lado");
	private JTextField txtlado2 = new JTextField();
	private JLabel lbn3 = new JLabel("Ingresa el tamaño del 3er. lado");
