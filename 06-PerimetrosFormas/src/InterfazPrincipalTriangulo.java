...
private JLabel lbn1 = new JLabel("ELIGE UNA OPCIÓN");
	...
	public InterfazPrincipalTriangulo(){
		super.setTitle("PERIMETROS TRIANGULOS");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnEqui){
			InterfazEsquilatero vtnequ = new InterfazEsquilatero();
			vtnequ.setVisible(true);
		}
	
		if(e.getSource()==btnEscal){
			InterfazEscaleno vtnesc = new InterfazEscaleno();
			vtnesc.setVisible(true);
					
		}
		
		if(e.getSource()==btnIsose){
			InterfazIsoseles vtnIso = new InterfazIsoseles();
			vtnIso.setVisible(true);
		}
	}
